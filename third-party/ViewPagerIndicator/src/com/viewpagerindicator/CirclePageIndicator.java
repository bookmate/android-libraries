...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCentered) {
            longOffset += ((longSize - longPaddingBefore - longPaddingAfter) / 2.0f) - ((count * threeRadius - mExtraSpacing) / 2.0f); // TODO: not the proper fix
        }
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            drawCircle(canvas, dX, dY, mRadius, pageFillRadius, mPaintPageFill);
        }
        ...
        drawCircle(canvas, dX, dY, mRadius, mRadius, mPaintFill);
    }

    protected void drawCircle(Canvas canvas, float dX, float dY, float radius, float pageFillRadius, Paint paintPageFill) {
